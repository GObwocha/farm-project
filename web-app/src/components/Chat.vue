...
const suggestedChips = ref([
  { label: 'Recommend a Farm Fresh Produce', prompt: 'Can you recommend some farm-fresh produce for the season?', icon: 'mdi-rocket-launch' },
  { label: 'Best Produce for the Season', prompt: 'What are the best produce options for the current season?', icon: 'mdi-emoticon-sad' },
  { label: 'Quick Recommendations', prompt: 'Show me fast or short produce recommendations for a busy week.', icon: 'mdi-clock-fast' },
  { label: 'Building a Healthy Diet', prompt: 'How can I build a consistent daily healthy eating habit?', icon: 'mdi-calendar-check' }
])
  ...
  <v-container class="chat-container">
    <v-card class="mx-auto" max-width="400" elevation="4">
        <v-card-title class="bg-primary align-center">
            ...
            Smart Farm Season online produce Guide
        </v-card-title>
      ...
      <v-card-actions class="pa-3">
        <v-text-field
          v-model="userInput"
          label="Ask for produce information, nutritional tips..."
          variant="outlined"
          density="compact"
          hide-details
